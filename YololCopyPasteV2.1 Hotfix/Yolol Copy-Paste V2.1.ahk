...
^Numpad7::PasteShipDesignMode(1) ;Ctrl Numpad 7
;hotkeymeplease::Cut(1)
;Set 2
^Numpad2::Copy(2) ;Ctrl Numpad 2
^Numpad5::Paste(2) ;Ctrl Numpad 5
^Numpad8::PasteShipDesignMode(2) ;Ctrl Numpad 8
;hotkeymeplease::Cut(2)
;Set3
^Numpad3::Copy(3) ;Ctrl Numpad 3
^Numpad6::Paste(3) ;Ctrl Numpad 6
^Numpad9::PasteShipDesignMode(3) ;Ctrl Numpad 9
;hotkeymeplease::Cut(3)
;Set 4
...
PasteShipDesignMode(clipboardID)
{
	global
	local oldClipboard := ClipboardAll 
	 Clipboard := ClipboardData%clipboardID%
